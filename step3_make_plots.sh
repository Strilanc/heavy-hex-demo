...
sinter plot \
    ...
    --filter_func "metadata['b'] == 'X' and 'correlated' in decoder" \
...
sinter plot \
    ...
    --x_func "metadata['d']" \
    --xaxis "Patch Diameter" \
    --filter_func "metadata['b'] == 'Z' and 'correlated' in decoder" \
...
sinter plot \
    ...
    --x_func "metadata['d']" \
    --xaxis "Patch Diameter" \
    --filter_func "metadata['b'] == 'X' and 'correlated' not in decoder" \
...
sinter plot \
    ...
    --x_func "metadata['d']" \
    --xaxis "Patch Diameter" \
    --filter_func "metadata['b'] == 'Z' and 'correlated' not in decoder" \
